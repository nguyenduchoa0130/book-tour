import { Button, Descriptions, Divider, Empty, Table, Tag, Typography } from 'antd';
  ...
  useEffect(() => {
    const getPaymentHistories = async () => {
      try {
        ...
        const data = await paymentService.getPaymentHistories(+userId);
  ...
  return (
    <>
      <div className='d-flex justify-content-between align-items-center'>
        ...
        <NavLink to='/admin/nguoi-dung/danh-sach'>
          <Button
            size='large'
